...
const Counter = () => {
  return (
    <div class="font-montserrat py-16">
      <div class="h-full overflow-y-auto">
        <div class="container mx-auto grid">
          <div class="grid gap-10 mb-8 md:grid-cols-2 xl:grid-cols-4 lg:mx-2 mx-7">
            <div class="flex items-center justify-center p-4 bg-white rounded-lg ">
              <div>
                <p class="mb-2 text-4xl font-bold text-center text-gray-800">
            ...
            <div class="flex items-center  justify-center p-4 bg-white rounded-lg ">
              <div>
                ...
                <p class="text-2xl font-medium text-gray-800">SELLER REVIEWS</p>
              </div>
            </div>
            <div class="flex items-center  justify-center p-4 bg-white rounded-lg ">
              <div>
