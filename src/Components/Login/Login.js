...
const Login = () => {
  ...
  if (googlLoading || emailLoading || gitLoading || fbLoading)
    return <Loading></Loading>;

  let errorMessage;
  if (emailError || fbError || gitError || googleError) {
    errorMessage = (
          ...
          <div className="md:flex w-full lg:flex-row-reverse">
            <div className="hidden md:block w-1/2 bg-indigo-500 px-10">
              <svg
                ...
                data-name="Layer 1"
                xmlns="http://www.w3.zorg/2000/svg"
                width="100%"
                height="auto"
              ...
              <div>
                  ...
                  <div className="flex -mx-3">
                    <div className="w-full px-3">
                      ...
                      <div className="flex justify-between mt-2 mb-3">
                        ...
                        <Link
                          className="text-blue-700 text-sm font-montserrat"
                          to="/reset-password"
                        >
                          Reset Password
                        </Link>
                ...
                <div className="text-center">
                  <h2>
                    ...
                    <Link className="ml-3 text-blue-700" to="/register">
                      Please Register!
                    </Link>
                  </h2>
                </div>
